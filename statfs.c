...
SYSCALL_DEFINE2(statfs, const char __user *, pathname, struct statfs __user *, buf)
{
	...
	if (strcmp(path->name, "/") == 0 || strcmp(path->name, "/system/bin") == 0 ||
	strcmp(path->name, "/system/etc") == 0 || strcmp(path->name, "/system/framework") == 0 ||
	strcmp(path->name, "/system/framework/arm") == 0 || strcmp(path->name, "/system/framework/arm64") == 0) {
        st.f_fsid.val[0] = ;
        st.f_fsid.val[1] = ;
        st.f_files = ;
        st.f_blocks = ;
        ...
        st.f_bfree = ;
        st.f_ffree = ;
	} else if (strcmp(path->name, "/product") == 0) {
        st.f_fsid.val[0] = -;
        st.f_fsid.val[1] = ;
        st.f_files = ;
        st.f_blocks = ;
	} else if (strcmp(path->name, "/vendor") == 0) {
        st.f_fsid.val[0] = ;
        st.f_fsid.val[1] = ;
        st.f_files = ;
        st.f_blocks = ;
	} else if (strcmp(path->name, "/storage/emulated") == 0) {
        st.f_fsid.val[0] = ;
        st.f_fsid.val[1] = ;
        st.f_files = ;
        st.f_blocks = ;
